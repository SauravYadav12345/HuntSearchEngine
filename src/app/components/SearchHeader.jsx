...
export const SearchHeader = () => {
  return (
    <header className="sticky top-0 bg-[#fafaf9]">
      <div className="flex w-full p-6 items-center justify-between">
        <Link href="/">
          <Image
            src="https://cdn.vectorstock.com/i/1000x1000/80/89/internet-search-engine-optimization-expose-vector-26128089.webp"
            alt="Hunt Logo"
            width={120}
            height={40}
            priority
